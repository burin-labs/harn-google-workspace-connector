...
`harn-google-workspace-connector` is public so that it gets free hosted CI and so that
`harn add github.com/burin-labs/harn-google-workspace-connector@<tag>` resolves without
