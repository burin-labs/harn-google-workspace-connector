# Contributing to harn-google-workspace-connector

This repository does not accept external contributions.

## Why

`harn-google-workspace-connector` is a generated and fleet-managed connector package. It carries the
Google Workspace side of the Harn connector contract and almost nothing else. Its
...
- Found a bug in how this connector handles Google Workspace, or want a connector that
